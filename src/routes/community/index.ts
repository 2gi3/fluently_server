...
router.post('/savedposts', mediumLimiter, auth, createSavedPost as RequestHandler);
...
router.get('/savedposts/:userId', mediumLimiter, auth, getSavedPosts as RequestHandler);
